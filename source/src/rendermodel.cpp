...
void renderclient(playerent *d, const char *mdlname, const char *vwepname, int tex)
{
    ...
    else if(d->weaponsel==d->lastattackweapon && lastmillis-d->lastaction<300 && d->lastpain < d->lastaction && !d->weaponsel->reloading && (d->weaponsel->type != GUN_GRENADE || ((grenades *)d->weaponsel)->activatemillis))
